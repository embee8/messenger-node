...
function RequestPayload (recipient, payload, persona_id) {
...
function AttachmentPayload (attachment, recipient, persona_id) {
  ...
  switch (source_type) {
    ...
    case 'file':
      ...
      if (persona_id) this.formData.persona_id = persona_id;
